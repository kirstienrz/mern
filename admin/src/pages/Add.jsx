...
const Add = ({token}) => {
  ...
  const [subCategory,setSubCategory] = useState("Chanel");
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:Gap-8'>
        ...
        <div>
          ...
          <select  onChange={(e) => setSubCategory(e.target.value)} className='w-full px-3 py-2'>
            ...
            <option value="Tatak">Tatak</option>
          </select>
        </div>
        <div>
          <p className='mb-2'>Product Price</p>
          <input  onChange={(e)=>setPrice(e.target.value)} value={price} type="Number" placeholder='2000'/>
        </div>
      </div>
